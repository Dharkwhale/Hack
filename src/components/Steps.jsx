...
const Steps = () => {
  return (
    <div className='bg-[#1A1919] px-4'>
        ...
        <h2 className='text-xl text-center text-[#95FF80] mt-8 w-933px leading-tight'>
    ...
    <div  >
        <div className= ' flex flex-col mt-8 md:flex-row justify-center items-stretch md:space-x-4 space-y-4 md:space-y-0'>
            <div className='flex flex-col text-white p-6 text-center border border-[#2a2a2a] rounded-lg'>
                <div className='text-left header flex p-4'>
            ...
            <div className='flex flex-col text-white p-6 text-center border border-[#2a2a2a] rounded-lg'>
                <div className='header flex p-4 text-left'>
