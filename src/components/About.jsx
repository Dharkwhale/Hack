...
const About = () => {
  return (
    <div className='bg-[#1A1919] px-4'>
        <h1 className="text-2xl text-center text-[#ffffff] mt-20 w-933px leading-tight">
          <span>Why Choose Us for Your Blockchain </span> <br />
          <span>Experience?</span>
        </h1>
        <div className="flex flex-col mt-10 md:flex-row justify-center items-stretch md:space-x-4 space-y-4 md:space-y-0">
    <div className="bg-gradient-to-r from-[#030303] to-[#1a1a1a] bg-opacity-30 backdrop-blur-md shadow-lg flex-1 h-full flex flex-col text-white p-6 text-center border border-[#2a2a2a] rounded-lg">
        <h3 className="text-[#95FF80] text-left">Secure Transactions</h3>
    ...
    <div className="bg-gradient-to-r from-[#1a1a1a] to-[#030303] bg-opacity-30 backdrop-blur-md shadow-lg flex-1 h-full flex flex-col text-white p-6 text-center border border-[#2a2a2a] rounded-lg">
        <h3 className="text-[#95FF80] text-left">Real-time Updates</h3>
        <p className="text-sm text-left flex-grow">
    ...
    <div className="bg-gradient-to-r from-[#1a1a1a] to-[#030303] bg-opacity-30 backdrop-blur-md shadow-lg flex-1 h-full flex flex-col text-white p-6 text-center border border-[#2a2a2a] rounded-lg">
        <h3 className="text-[#95FF80] text-left">Multi-Wallet Integration</h3>
        <p className="text-sm text-left flex-grow">
    ...
    <div className="bg-gradient-to-r from-[#1a1a1a] to-[#030303] bg-opacity-30 backdrop-blur-md shadow-lg flex-1 h-full flex flex-col text-white p-6 text-center border border-[#2a2a2a] rounded-lg">
        <h3 className="text-[#95FF80] text-left">Low Fees for Maximum Value</h3>
        <p classNameclassName="text-sm text-left flex-grow">
