...
const Navbar = () => {
  ...
  return (
    ...
    <div>
      <span class='text-[#1e9400] text-2xl font-bold'>H</span>ackathon
    </div>
    <ul class = 'hidden md:flex'>
        ...
        <div>
      <button  onClick={handleSignInClick} class='bg-[#1e9400] W-[250px] rounded-md font-small py-2 px-4 text-[#000000]'>Sign In</button>
    </div>  
