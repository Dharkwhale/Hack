...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-12 max-w-[1240px] mx-auto px-6 text-white'> 
    <div>
      <img src={Logo} alt='Testimonial img' />
    </div>
    <ul className = 'hidden md:flex'>
          <li className = 'p-4 text-[#1e9400]'>Home</li>
    ...
    <div className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000000] easy-in-out duration-500 md:hidden' : 'fixed left-[-100%]'}>
    <div>
      <span className='text-[#1e9400] text-2xl font-bold m-4'>H</span>ackathon
    </div>
      <ul className='pt-12 p-4 md:hidden'>
          <li className = 'p-4 border-b border-gray-600 text-[#1e9400]'>Home</li>
