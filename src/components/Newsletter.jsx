    ...
    <div class="flex px-4">
      ...
      <div class="">
        <div className="bg-gradient-to-r from-[#030303] to-[#1a1a1a] bg-opacity-30 backdrop-blur-md shadow-lg h-full grid text-white p-6 text-center border border-[#2a2a2a] rounded-lg">
          ...
          <p className="text-sm text-left">David Richards</p>
          <p className="text-sm text-left">Freelance digital entrepreneur</p>
          <div
            class=""
            style={{
              display: "flex",
        ...
        <div className="flex flex-col justify-center space-y-4">
          <div className="flex items-center max-w-md space-x-4">
            ...
            />
            <button className="bg-[#1e9400]  rounded-md font-medium py-2 px-2 text-black hidden md:block">
              Notify Me
            </button>
          </div>
        </div>
