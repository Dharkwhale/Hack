...
const Service = () => {
  return (
    <div className='bg-[#1A1919] px-4'>
        <h1 className="text-2xl text-center text-[#ffffff] mt-20 w-933px">
          <span>Hackathon’s Services </span>
        </h1>
        <div className='flex flex-col mt-8 md:flex-row justify-center items-stretch md:space-x-4 space-y-4 md:space-y-0'>
        ...
        <h2 className='text-sm text-left'>Service 1</h2>
        <p className='text-xl text-[#95FF80] text-left'>Asset Management</p>
        ...
        <div className="bg-gradient-to-r from-[#030303] to-[#1a1a1a] bg-opacity-30 backdrop-blur-md shadow-lg flex-1 h-full flex flex-col text-white p-6 text-center border border-[#2a2a2a] rounded-lg">
        <h2 className='text-sm text-left'>Service 2</h2>
        <p className='text-xl text-[#95FF80] text-left'>Asset Management</p>
        <p className='text-sm text-left'>
        ...
        <div className="bg-gradient-to-r from-[#030303] to-[#1a1a1a] bg-opacity-30 backdrop-blur-md shadow-lg flex-1 h-full flex flex-col text-white p-6 text-center border border-[#2a2a2a] rounded-lg">
        <h2 className='text-sm text-left'>Service 3</h2>
        <p className='text-xl text-[#95FF80] text-left'>Low-Fee Transfers</p>
        <p className='text-sm text-left'>
